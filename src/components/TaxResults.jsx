					...
					>
						<CardContent sx={{ p: 3 }}>
							...
							<Typography
								...
								sx={{ fontStyle: "italic" }}
							>
								DTAA credit reduces your Indian tax liability by the amount of
								US taxes paid on RSU income.
							</Typography>
						</CardContent>
					</Card>
				)}
						...
						<CardContent sx={{ p: 3 }}>
							...
							<Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
								...
								<Box sx={{ display: "flex", justifyContent: "space-between" }}>
									...
									<Typography variant="body1" sx={{ fontWeight: 600 }}>
										{formatCurrency(summary.oldRegime.taxableIncome)}
									</Typography>
								</Box>
								...
								>
									...
									>
										...
										<Typography variant="body2">
											{formatCurrency(summary.oldRegime.tax)}
										</Typography>
									</Box>
									{summary.oldRegime.surcharge > 0 && (
										...
										>
											...
											<Typography variant="body2">
												{formatCurrency(summary.oldRegime.surcharge)}
											</Typography>
										</Box>
									)}
									<Box
									...
									>
										...
										<Typography variant="body2">
											{formatCurrency(summary.oldRegime.cess)}
										</Typography>
									</Box>
						...
						<CardContent sx={{ p: 3 }}>
							...
							<Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
								...
								<Box sx={{ display: "flex", justifyContent: "space-between" }}>
									...
									<Typography variant="body1" sx={{ fontWeight: 600 }}>
										{formatCurrency(summary.newRegime.taxableIncome)}
									</Typography>
								</Box>
								...
								>
									...
									>
										...
										<Typography variant="body2">
											{formatCurrency(
												summary.newRegime.tax + summary.newRegime.rebate,
											)}
										</Typography>
									</Box>
									...
									{summary.newRegime.surcharge > 0 && (
										...
										>
											...
											<Typography variant="body2">
												{formatCurrency(summary.newRegime.surcharge)}
											</Typography>
										</Box>
									)}
									<Box
									...
									>
										...
										<Typography variant="body2">
											{formatCurrency(summary.newRegime.cess)}
										</Typography>
									</Box>
					...
					<CardContent sx={{ p: 4 }}>
						...
						>
							<SavingsIcon
								sx={{
									mr: 1,
									color: isNewRegimeBetter ? "success.main" : "info.main",
								}}
							/>
							<Typography
								variant="body1"
								...
								sx={{ fontWeight: 600 }}
							>
								{isNewRegimeBetter ? "You save" : "You pay more"} with New
								Regime:
							</Typography>
						</Box>
						<Typography
