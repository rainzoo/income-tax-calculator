          ...
          <Box component="footer" mt={8} textAlign="center">
            <Box
              sx={{
                ...
                '&::before': {
                  ...
                  right: 0,
                  height: '4px',
                  background: 'linear-gradient(90deg, #1565c0, #42a5f5, #0d47a1)',
            ...
            >
              ...
              <Typography variant="body1" color="text.secondary" gutterBottom sx={{ mb: 2, fontWeight: 500 }}>
                This calculator provides estimates based on FY 2025-26 Indian tax rules and regulations.
              </Typography>
              <Typography variant="body2" color="text.secondary" gutterBottom sx={{ mb: 3 }}>
                For accurate tax planning and filing, please consult with a qualified Chartered Accountant or tax advisor.
